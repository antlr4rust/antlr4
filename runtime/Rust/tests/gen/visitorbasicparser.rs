...
pub const VisitorBasic_A: isize = 1;
pub const VisitorBasic_EOF: isize = EOF;
    ...
    pub fn s(&mut self) -> Result<Rc<SContextAll<'input>>, ANTLRError> {
        ...
        let result: Result<(), ANTLRError> = (|| {
            ...
            recog.base.enter_outer_alt(None, 1);
            {
                ...
                recog
                    .base
                    .match_token(VisitorBasic_A, &mut recog.err_handler)?;

                recog.base.set_state(3);
                recog
                    .base
                    .match_token(VisitorBasic_EOF, &mut recog.err_handler)?;
            }
            Ok(())
        })();
        match result {
...
lazy_static! {
    ...
    static ref _serializedATN: Vec<isize> = vec![
        4, 1, 1, 6, 2, 0, 7, 0, 1, 0, 1, 0, 1, 0, 1, 0, 0, 0, 1, 0, 0, 0, 4, 0, 2, 1, 0, 0, 0, 2,
        3, 5, 1, 0, 0, 3, 4, 5, 0, 0, 1, 4, 1, 1, 0, 0, 0, 0
    ];
}
