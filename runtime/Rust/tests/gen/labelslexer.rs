...
impl<'input, Input:CharStream<From<'input> >> TokenSource<'input> for LabelsLexer<'input,Input>{
	...
	const _serializedATN: [i32; 429] = [
		...
		6, 4, 6, 35, 8, 6, 11, 6, 12, 6, 36, 1, 7, 4, 7, 40, 8, 7, 11, 7, 12, 
		7, 41, 1, 8, 1, 8, 1, 8, 1, 8, 0, 0, 9, 1, 1, 3, 2, 5, 3, 7, 4, 9, 5, 
		11, 6, 13, 7, 15, 8, 17, 9, 1, 0, 1, 2, 0, 10, 10, 32, 32, 48, 0, 1, 1, 
		...
		25, 1, 0, 0, 0, 9, 27, 1, 0, 0, 0, 11, 30, 1, 0, 0, 0, 13, 34, 1, 0, 0, 
		0, 15, 39, 1, 0, 0, 0, 17, 43, 1, 0, 0, 0, 19, 20, 5, 42, 0, 0, 20, 2, 
		1, 0, 0, 0, 21, 22, 5, 43, 0, 0, 22, 4, 1, 0, 0, 0, 23, 24, 5, 40, 0, 
		0, 24, 6, 1, 0, 0, 0, 25, 26, 5, 41, 0, 0, 26, 8, 1, 0, 0, 0, 27, 28, 
		5, 43, 0, 0, 28, 29, 5, 43, 0, 0, 29, 10, 1, 0, 0, 0, 30, 31, 5, 45, 0, 
		0, 31, 32, 5, 45, 0, 0, 32, 12, 1, 0, 0, 0, 33, 35, 2, 97, 122, 0, 34, 
		33, 1, 0, 0, 0, 35, 36, 1, 0, 0, 0, 36, 34, 1, 0, 0, 0, 36, 37, 1, 0, 
		0, 0, 37, 14, 1, 0, 0, 0, 38, 40, 2, 48, 57, 0, 39, 38, 1, 0, 0, 0, 40, 
		41, 1, 0, 0, 0, 41, 39, 1, 0, 0, 0, 41, 42, 1, 0, 0, 0, 42, 16, 1, 0, 
		0, 0, 43, 44, 7, 0, 0, 0, 44, 45, 1, 0, 0, 0, 45, 46, 6, 8, 0, 0, 46, 
		18, 1, 0, 0, 0, 3, 0, 36, 41, 1, 6, 0, 0
	];